import{_ as s}from"./chunks/diary_detail_todo.Db_GSx-g.js";import{_ as n,c as p,o as e,ae as l}from"./chunks/framework.B0V9E2-J.js";const i="/readme/assets/todo_sort.CAiSw7nw.png",b=JSON.parse('{"title":"待办列表 TODO","description":"","frontmatter":{},"headers":[],"relativePath":"diary/待办列表.md","filePath":"diary/待办列表.md"}'),t={name:"diary/待办列表.md"};function o(c,a,r,d,h,_){return e(),p("div",null,a[0]||(a[0]=[l(`<h1 id="待办列表-todo" tabindex="-1">待办列表 TODO <a class="header-anchor" href="#待办列表-todo" aria-label="Permalink to &quot;待办列表 TODO&quot;">​</a></h1><p>这也算是一个比较特殊的功能。<br> 平时会记录一些要做的事项到 iPhone 的待办列表，为了统一管理，在这个项目中也添加了差不多的功能。区别是，这里只支持记录，不支持提醒等。</p><p>我平常会用它用记录一年的待办、一些项目待实现功能记录、想买的东西等。</p><h2 id="_1-待办的书写规则" tabindex="-1">1. 待办的书写规则 <a class="header-anchor" href="#_1-待办的书写规则" aria-label="Permalink to &quot;1. 待办的书写规则&quot;">​</a></h2><p>待办日记本质还是纯文本，但感觉 markdown 那种 <code>-[]</code> <code>-[x]</code> 书写方式太过繁琐，所以制定了自己的待办列表书写规则。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>= 开头的是已完成的</span></span>
<span class="line"><span>- 开头的是未完成的</span></span></code></pre></div><h2 id="_2-展示方式" tabindex="-1">2. 展示方式 <a class="header-anchor" href="#_2-展示方式" aria-label="Permalink to &quot;2. 展示方式&quot;">​</a></h2><p>当日记内容是下面内容时</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- 进入统计页面时，因加载时间过长，添加过渡动画 使用 router</span></span>
